      ...
      <div className="flex flex-col flex-1 p-6">
        ...
        <div className="mt-6 pt-5 border-t border-slate-100 flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 text-xs font-bold rounded-xl bg-brand-navy text-white hover:bg-brand-navyDark shadow-sm hover:shadow-md transition-all active:scale-95"
          >
            Enrol Now →
          </button>
        </div>
